...
export function ValidationCard({ result, isReportSigned = false, isValidationExpired = false, validationContext, onCreditConsumed, onRefresh }: ValidationCardProps) {
                  ...
                  <>
                    ...
                    <div className="bg-[#f0f9ff] border-2 border-dashed border-[#3b82f6] rounded-lg p-4">
                      ...
                      <GlowButton
                        ...
                        disabled={isGenerating || isValidationExpired}
                        title={isValidationExpired ? "Validation expired (>48 hours). AI features disabled." : "Provide context to help AI generate better questions"}
                      >
              ...
              <div className="flex flex-wrap gap-2 md:gap-3">
                ...
                {shouldShowSmartQuestions() && (
                  <GlowButton
                    ...
                    disabled={isReportSigned || isValidationExpired}
                    title={isReportSigned ? "Report is signed off - no updates allowed" : isValidationExpired ? "Validation expired (>48 hours). AI features disabled." : ""}
                  >
                ...
                <GlowButton
                  ...
                  disabled={isRevalidating || isReportSigned || isValidationExpired}
                  title={isReportSigned ? "Report is signed off - no updates allowed" : isValidationExpired ? "Validation expired (>48 hours). AI features disabled." : ""}
                >
